...
# 旧版解释器直接提示不兼容
if [[ 1 == 2 ]]; then
    bash rm /tmp/AdobeAIRInstaller_32.0.0.125.exe
    bash rm /tmp/temp.exe
    ...
    download https://code.gitlink.org.cn/gfdgd_xi/wine-runner-list/raw/branch/master/other/scratch1.0.exe /tmp temp.exe
